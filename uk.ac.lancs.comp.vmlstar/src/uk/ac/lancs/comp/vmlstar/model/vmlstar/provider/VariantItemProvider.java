...
/**
 * This is the item provider adapter for a {@link uk.ac.lancs.comp.vmlstar.model.vmlstar.Variant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariantItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         VmlstarPackage.Literals.VARIANT__FEATURE,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(VmlstarPackage.Literals.VARIANT__ON_SELECT);
      childrenFeatures.add(VmlstarPackage.Literals.VARIANT__ON_UN_SELECT);
    }
