...
/**
 * This is the item provider adapter for a {@link uk.ac.lancs.comp.vmlstar.model.vmlstar.Concern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcernItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         VmlstarPackage.Literals.CONCERN__NAME,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(VmlstarPackage.Literals.CONCERN__SUB_CONCERNS);
      childrenFeatures.add(VmlstarPackage.Literals.CONCERN__VARIANTS);
      childrenFeatures.add(VmlstarPackage.Literals.CONCERN__POINTCUTS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add
      (createChildParameter
        (VmlstarPackage.Literals.CONCERN__SUB_CONCERNS,
         VmlstarFactory.eINSTANCE.createConcern()));

    newChildDescriptors.add
      (createChildParameter
        (VmlstarPackage.Literals.CONCERN__VARIANTS,
         VmlstarFactory.eINSTANCE.createVariant()));

    newChildDescriptors.add
      (createChildParameter
        (VmlstarPackage.Literals.CONCERN__POINTCUTS,
