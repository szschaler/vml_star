...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Action Descriptor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link uk.ac.lancs.comp.vmlLangInst.impl.ActionDescriptorImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.ac.lancs.comp.vmlLangInst.impl.ActionDescriptorImpl#getNumParams <em>Num Params</em>}</li>
 *   <li>{@link uk.ac.lancs.comp.vmlLangInst.impl.ActionDescriptorImpl#getEvaluatorClass <em>Evaluator Class</em>}</li>
 *   <li>{@link uk.ac.lancs.comp.vmlLangInst.impl.ActionDescriptorImpl#getEvaluatorMethod <em>Evaluator Method</em>}</li>
 *   <li>{@link uk.ac.lancs.comp.vmlLangInst.impl.ActionDescriptorImpl#getCheckMethod <em>Check Method</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ActionDescriptorImpl extends EObjectImpl implements ActionDescriptor {
  /**
   ...
   * @generated
   */
  protected ActionDescriptorImpl() {
    super();
  }
  ...
  protected EClass eStaticClass() {
    return VmlLangInstPackage.Literals.ACTION_DESCRIPTOR;
  }
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VmlLangInstPackage.ACTION_DESCRIPTOR__NAME, oldName, name));
  }
  ...
  public void setNumParams(int newNumParams) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VmlLangInstPackage.ACTION_DESCRIPTOR__NUM_PARAMS, oldNumParams, numParams));
  }
  ...
  public void setEvaluatorClass(String newEvaluatorClass) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VmlLangInstPackage.ACTION_DESCRIPTOR__EVALUATOR_CLASS, oldEvaluatorClass, evaluatorClass));
  }
  ...
  public void setEvaluatorMethod(String newEvaluatorMethod) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VmlLangInstPackage.ACTION_DESCRIPTOR__EVALUATOR_METHOD, oldEvaluatorMethod, evaluatorMethod));
  }
  ...
  public void setCheckMethod(String newCheckMethod) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VmlLangInstPackage.ACTION_DESCRIPTOR__CHECK_METHOD, oldCheckMethod, checkMethod));
  }
