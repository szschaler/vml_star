...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Feature Model Adapter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link uk.ac.lancs.comp.vmlLangInst.impl.FeatureModelAdapterImpl#getAdapterClass <em>Adapter Class</em>}</li>
 *   <li>{@link uk.ac.lancs.comp.vmlLangInst.impl.FeatureModelAdapterImpl#getAdapterOperation <em>Adapter Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FeatureModelAdapterImpl extends EObjectImpl implements FeatureModelAdapter {
  /**
   ...
   * @generated
   */
  protected FeatureModelAdapterImpl() {
    super();
  }
  ...
  protected EClass eStaticClass() {
    return VmlLangInstPackage.Literals.FEATURE_MODEL_ADAPTER;
  }
  ...
  public void setAdapterClass(String newAdapterClass) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VmlLangInstPackage.FEATURE_MODEL_ADAPTER__ADAPTER_CLASS, oldAdapterClass, adapterClass));
  }
  ...
  public void setAdapterOperation(String newAdapterOperation) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VmlLangInstPackage.FEATURE_MODEL_ADAPTER__ADAPTER_OPERATION, oldAdapterOperation, adapterOperation));
  }
